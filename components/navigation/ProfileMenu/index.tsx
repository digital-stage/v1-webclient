            ...
            <React.Fragment>
                ...
                >
                    ...
                    >
                        ...
                        <Text variant="h6" sx={{color: 'text'}} ml={3} onClick={() => setDownloadClientOpen(true)}>
                            {f('clientDownload')}
                        </Text>
                    </Flex>
                ...
                <DownloadClientOverlay isOpen={downloadClientOpen} onClose={() => setDownloadClientOpen(false)}/>
            </React.Fragment>
        );
    }
    return null;
