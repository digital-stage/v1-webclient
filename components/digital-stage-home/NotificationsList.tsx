...
import Avatar from "../digital-stage-ui/Avatar";
        ...
        <h5 style={{color:"white", textAlign:"left", padding:"20px 20px"}}>Notifications</h5>
            <div className="search-section">
                <div style={{ display: "inline-block" }}>
                    <Input list={list} onChange={onChangeHandler} clear={clearInput} selected={searchedWord} placeholder="Search notifications" />
