...
import {
    useAudioProducers, useCustomAudioProducers,
    useCustomGroups, useCustomStageMembers,
    useIsStageAdmin,
    useSelector,
    useStageMembers,
    useUsers
                        ...
                        >
                            ...
                            >
                                <ChannelStrip
                                    ...
                                    analyserL={byGroup && byGroup[group._id] ? byGroup[group._id].analyserNodeL : undefined}
                                    analyserR={byGroup && byGroup[group._id] ? byGroup[group._id].analyserNodeR : undefined}
                                >
                                    {stageMembers.byGroup[group._id] && (
                                        ...
                                        >
                                            {stageMembers.byGroup[group._id].map(id => stageMembers.byId[id]).map((stageMember, index, arr) => {
                                                ...
                                                return (
                                                    <ChannelStrip
                                                        ...
                                                        channel={globalMode
                                                            ? stageMember
                                                            : customStageMember || stageMember}
                                                        icon={<img src="static/images/avatar.svg"/>}
                                                        resettable={(globalMode && (stageMember.volume !== 1 || stageMember.muted)) || !!customStageMember}
                                                        onReset={() => {
                                                            if (globalMode) {
                                                        ...
                                                        analyserL={byStageMember && byStageMember[stageMember._id] ? byStageMember[stageMember._id].analyserNodeL : undefined}
                                                        analyserR={byStageMember && byStageMember[stageMember._id] ? byStageMember[stageMember._id].analyserNodeR : undefined}
                                                    >
                                                        {audioProducers.byStageMember[stageMember._id] && (
                                                            <Flex
                                                                ...
                                                                {audioProducers.byStageMember[stageMember._id].map(id => audioProducers.byId[id]).map((audioProducer, index, arr) => {
                                                                    ...
                                                                    return (
                                                                        <ChannelStrip
                                                                            ...
                                                                            channel={globalMode ? audioProducer : customAudioProducer || audioProducer}
                                                                            global={globalMode}
                                                                            resettable={(globalMode && (audioProducer.volume !== 1 || audioProducer.muted)) || !!customAudioProducer}
                                                                            onReset={() => {
                                                                                if (globalMode) {
                                                                            ...
                                                                            analyserL={byAudioProducer && byAudioProducer[audioProducer._id] ? byAudioProducer[audioProducer._id].analyserNode : undefined}
                                                                        />
                                                                    )
                                                                })}
                                                            </Flex>
