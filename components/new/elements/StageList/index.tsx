...
import { jsx, Grid, Box, Divider, Flex, Button, IconButton, Heading, Avatar } from 'theme-ui';
      ...
      <Flex sx={{ flexDirection: 'column' }}>
        {stages.map((stage) => (
          <Collapse key={stage._id}  id={stage._id}>
              <CollapseHeader isOpen={openCollapse} onClick={() => setOpenCollapse(!openCollapse)}>
              ...
              <CollapseBody isOpen={openCollapse}>
                <Box sx={{ bg: 'gray.5', mx: '-32px', px: '38px' }}>
