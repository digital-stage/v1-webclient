...
function initStore(preloadedState: NormalizedState = InitialNormalizedState): Store<NormalizedState, ReducerAction> {
...
export const initializeStore = (preloadedState: NormalizedState): Store<NormalizedState, ReducerAction> => {
