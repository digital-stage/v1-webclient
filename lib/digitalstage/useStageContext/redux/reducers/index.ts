...
const stageReducer: Reducer<NormalizedState, ReducerAction> = (
  ...
  switch (action.type) {
        ...
        stages: {
          ...
          byId: {
            ...
            [action.payload._id]: {
              ...action.payload,
              isAdmin: state.user
                ? (action.payload as Stage).admins.indexOf(state.user._id)
                  !== -1
                : false,
            },
          },
        ...
        stages: {
          ...
          byId: {
            ...
            [action.payload._id]: {
              ...
              isAdmin:
                state.user
                && state.stages.byId[action.payload._id].admins.find(
                  (adminId) => adminId === state.user._id,
                ),
            },
          },
        },
        ...
        groups: {
          ...
          byStage: {
            ...
            [action.payload.stageId]: upsert<string>(
              state.groups.byStage[action.payload.stageId],
              action.payload._id,
            ),
          },
    ...
    case ServerStageEvents.GROUP_REMOVED:
      return {
        ...
        groups: {
          ...
          byStage: {
            ...state.groups.byStage,
            [state.groups.byId[action.payload].stageId]: _.filter(
              state.groups.byStage[state.groups.byId[action.payload].stageId],
    ...
    case ServerStageEvents.CUSTOM_GROUP_REMOVED:
      return {
        ...
        customGroups: {
          ...
          byGroup: _.omit(
            state.customGroups.byGroup,
            state.customGroups.byId[action.payload].groupId,
          ),
          allIds: _.filter(
            state.customGroups.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
    ...
    case ServerStageEvents.STAGE_MEMBER_ADDED:
      return {
        ...
        stageMembers: {
          ...state.stageMembers,
          ...addItemToCollection<StageMember>(
            state.stageMembers,
            action.payload._id,
            action.payload,
          ),
          byStage: {
            ...
            [action.payload.stageId]: upsert<string>(
              state.stageMembers.byStage[action.payload.stageId],
              action.payload._id,
            ),
          },
          byGroup: {
            ...
            [action.payload.groupId]: upsert<string>(
              state.stageMembers.byStage[action.payload.groupId],
              action.payload._id,
            ),
          },
        },
    ...
    case ServerStageEvents.STAGE_MEMBER_CHANGED:
      if (state.stageMembers.byId[action.payload._id]) {
        ...
        if (action.payload.groupId && oldGroupId !== action.payload.groupId) {
          ...
          state.stageMembers.byGroup[oldGroupId] = filter(
            state.stageMembers.byGroup[oldGroupId],
            action.payload._id,
          );
          // Add new byGroup
          state.stageMembers.byGroup[action.payload.groupId] = upsert<string>(
            state.stageMembers.byGroup[action.payload.groupId],
            action.payload._id,
          );
        }
      }
    ...
    case ServerStageEvents.STAGE_MEMBER_REMOVED:
      return {
        ...
        stageMembers: {
          ...
          byStage: {
            ...state.stageMembers.byStage,
            [state.stageMembers.byId[action.payload].stageId]: _.filter(
              state.stageMembers.byStage[
                state.stageMembers.byId[action.payload].stageId
              ],
              (id) => id !== action.payload,
            ),
          },
          byGroup: {
            ...state.stageMembers.byGroup,
            [state.stageMembers.byId[action.payload].groupId]: _.filter(
              state.stageMembers.byGroup[
                state.stageMembers.byId[action.payload].groupId
              ],
              (id) => id !== action.payload,
            ),
          },
          allIds: _.filter(
            state.stageMembers.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
    ...
    case ServerStageEvents.CUSTOM_STAGE_MEMBER_REMOVED:
      return {
        ...
        customStageMembers: {
          ...
          byStageMember: _.omit(
            state.customStageMembers.byStageMember,
            state.customStageMembers.byId[action.payload].stageMemberId,
          ),
          allIds: _.filter(
            state.stageMembers.allIds,
            (id) => id !== action.payload,
      ...
      return {
        ...
        audioProducers: {
          ...
          byStage: {
            ...
            [action.payload.stageId]: upsert(
              state.audioProducers.byStage[action.payload.stageId],
              action.payload._id,
            ),
          },
          byStageMember: {
            ...state.audioProducers.byStageMember,
            [action.payload.stageMemberId]: upsert(
              state.audioProducers.byStageMember[action.payload.stageMemberId],
              action.payload._id,
            ),
          },
    ...
    case ServerStageEvents.STAGE_MEMBER_AUDIO_REMOVED:
      return {
        ...
        audioProducers: {
          ...
          byStage: {
            ...state.audioProducers.byStage,
            [state.audioProducers.byId[action.payload].stageId]: _.filter(
              state.audioProducers.byStage[
                state.audioProducers.byId[action.payload].stageId
              ],
              (id) => id !== action.payload,
            ),
          },
          byStageMember: {
            ...state.audioProducers.byStageMember,
            [state.audioProducers.byId[action.payload].stageMemberId]: _.filter(
              state.audioProducers.byStageMember[
                state.audioProducers.byId[action.payload].stageMemberId
              ],
              (id) => id !== action.payload,
            ),
          },
          allIds: _.filter(
            state.audioProducers.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
    ...
    case ServerStageEvents.CUSTOM_STAGE_MEMBER_AUDIO_ADDED:
      return {
        ...
        customAudioProducers: {
          ...
          ...addItemToCollection<CustomAudioProducer>(
            state.customAudioProducers,
            action.payload._id,
            action.payload,
          ),
    ...
    case ServerStageEvents.CUSTOM_STAGE_MEMBER_AUDIO_REMOVED:
      return {
        ...
        customAudioProducers: {
          ...
          byAudioProducer: _.omit(
            state.customAudioProducers.byAudioProducer,
            state.customAudioProducers.byId[action.payload]
      ...
      return {
        ...
        videoProducers: {
          ...
          byStage: {
            ...
            [action.payload.stageId]: upsert(
              state.videoProducers.byStage[action.payload.stageId],
              action.payload._id,
            ),
          },
          byStageMember: {
            ...
            [action.payload.stageMemberId]: upsert(
              state.videoProducers.byStageMember[action.payload.stageMemberId],
              action.payload._id,
            ),
          },
    ...
    case ServerStageEvents.STAGE_MEMBER_VIDEO_REMOVED:
      if (!state.videoProducers.byId[action.payload]) {
        console.error(
          `Could not remove requested producer with id=${action.payload}`,
        );
        return state;
      }
      return {
        ...
        videoProducers: {
          ...
          byStage: {
            ...state.videoProducers.byStage,
            [state.videoProducers.byId[action.payload].stageId]: _.filter(
              state.videoProducers.byStage[
                state.videoProducers.byId[action.payload].stageId
              ],
              (id) => id !== action.payload,
            ),
          },
          byStageMember: {
            ...state.videoProducers.byStageMember,
            [state.videoProducers.byId[action.payload].stageMemberId]: _.filter(
              state.videoProducers.byStageMember[
                state.videoProducers.byId[action.payload].stageMemberId
              ],
              (id) => id !== action.payload,
            ),
          },
          allIds: _.filter(
            state.videoProducers.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
      ...
      return {
        ...
        ovTracks: {
          ...
          byStageMember: {
            ...
            [action.payload.stageMemberId]: upsert(
              state.ovTracks.byStageMember[action.payload.stageMemberId],
              action.payload._id,
            ),
          },
    ...
    case ServerStageEvents.STAGE_MEMBER_OV_REMOVED:
      return {
        ...
        ovTracks: {
          ...
          byStageMember: {
            ...state.ovTracks.byStageMember,
            [state.ovTracks.byId[action.payload].stageMemberId]: _.filter(
              state.ovTracks.byStageMember[
                state.ovTracks.byId[action.payload].stageMemberId
              ],
              (id) => id !== action.payload,
            ),
          },
          allIds: _.filter(
            state.ovTracks.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
    case ServerStageEvents.CUSTOM_STAGE_MEMBER_OV_ADDED:
      return {
        ...
        customOvTracks: {
          ...
          ...addItemToCollection<CustomOvTrack>(
            state.customOvTracks,
            action.payload._id,
            action.payload,
          ),
    ...
    case ServerStageEvents.CUSTOM_STAGE_MEMBER_OV_REMOVED:
      return {
        ...
        customOvTracks: {
          ...
          byOvTrack: _.omit(
            state.customOvTracks.byOvTrack,
            state.customOvTracks.byId[action.payload].stageMemberOvTrackId,
          ),
          allIds: _.filter(
            state.customOvTracks.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
      ...
      return {
        ...
        audioConsumers: {
          ...
          byStage: {
            ...
            [action.payload.stage]: upsert<string>(
              state.audioConsumers.byStage[action.payload.stage],
              action.payload._id,
            ),
          },
          byStageMember: {
            ...state.audioConsumers.byStageMember,
            [action.payload.stageMember]: upsert<string>(
              state.audioConsumers.byStageMember[action.payload.stageMember],
              action.payload._id,
            ),
          },
    ...
    case AdditionalReducerTypes.REMOVE_AUDIO_CONSUMER:
      return {
        ...
        audioConsumers: {
          ...
          byStageMember: {
            ...state.audioConsumers.byStageMember,
            [state.audioConsumers.byId[action.payload].stageMember]: _.filter(
              state.audioConsumers.byStageMember[
                state.audioConsumers.byId[action.payload].stageMember
              ],
              (id) => id !== action.payload,
            ),
          },
          byStage: {
            ...state.audioConsumers.byStage,
            [state.audioConsumers.byId[action.payload].stage]: _.filter(
              state.audioConsumers.byStage[
                state.audioConsumers.byId[action.payload].stage
              ],
              (id) => id !== action.payload,
            ),
          },
          byProducer: _.omit(
            state.audioConsumers.byProducer,
            state.audioConsumers.byId[action.payload].audioProducer,
          ),
          allIds: _.filter(
            state.audioConsumers.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
      ...
      return {
        ...
        videoConsumers: {
          ...
          byStage: {
            ...
            [action.payload.stage]: upsert<string>(
              state.videoConsumers.byStage[action.payload.stage],
              action.payload._id,
            ),
          },
          byStageMember: {
            ...
            [action.payload.stageMember]: upsert<string>(
              state.videoConsumers.byStageMember[action.payload.stageMember],
              action.payload._id,
            ),
          },
    ...
    case AdditionalReducerTypes.REMOVE_VIDEO_CONSUMER:
      return {
        ...
        videoConsumers: {
          ...
          byStageMember: {
            ...state.videoConsumers.byStageMember,
            [state.videoConsumers.byId[action.payload].stageMember]: _.filter(
              state.videoConsumers.byStageMember[
                state.videoConsumers.byId[action.payload].stageMember
              ],
              (id) => id !== action.payload,
            ),
          },
          byStage: {
            ...state.videoConsumers.byStage,
            [state.videoConsumers.byId[action.payload].stage]: _.filter(
              state.videoConsumers.byStage[
                state.videoConsumers.byId[action.payload].stage
              ],
              (id) => id !== action.payload,
            ),
          },
          byProducer: _.omit(
            state.videoConsumers.byProducer,
            state.videoConsumers.byId[action.payload].videoProducer,
          ),
          allIds: _.filter(
            state.videoConsumers.allIds,
            (id) => id !== action.payload,
          ),
        },
      };
