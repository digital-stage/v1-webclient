        ...
        stages: {
          ...
          byId: {
            ...
            [action.payload._id]: {
              ...action.payload,
              isAdmin: state.user
                ? (action.payload as Stage).admins.indexOf(state.user._id) !== -1
                : false,
            },
          },
        ...
        stageMembers: {
          ...
          byStage: {
            ...
            [state.stageMembers.byId[action.payload].stageId]: _.filter(
              state.stageMembers.byStage[state.stageMembers.byId[action.payload].stageId],
              (id) => id !== action.payload
            ),
          },
          byGroup: {
            ...
            [state.stageMembers.byId[action.payload].groupId]: _.filter(
              state.stageMembers.byGroup[state.stageMembers.byId[action.payload].groupId],
              (id) => id !== action.payload
            ),
          },
        ...
        audioProducers: {
          ...
          byStage: {
            ...
            [state.audioProducers.byId[action.payload].stageId]: _.filter(
              state.audioProducers.byStage[state.audioProducers.byId[action.payload].stageId],
              (id) => id !== action.payload
            ),
          },
          byStageMember: {
      ...
      return {
        ...
        customAudioProducers: {
          ...
          byAudioProducer: _.omit(
            state.customAudioProducers.byAudioProducer,
            state.customAudioProducers.byId[action.payload].stageMemberAudioProducerId
          ),
        ...
        videoProducers: {
          ...
          byStage: {
            ...
            [state.videoProducers.byId[action.payload].stageId]: _.filter(
              state.videoProducers.byStage[state.videoProducers.byId[action.payload].stageId],
              (id) => id !== action.payload
            ),
          },
          byStageMember: {
        ...
        ovTracks: {
          ...
          byStageMember: {
            ...
            [state.ovTracks.byId[action.payload].stageMemberId]: _.filter(
              state.ovTracks.byStageMember[state.ovTracks.byId[action.payload].stageMemberId],
              (id) => id !== action.payload
            ),
          },
        ...
        audioConsumers: {
          ...
          byStage: {
            ...
            [state.audioConsumers.byId[action.payload].stage]: _.filter(
              state.audioConsumers.byStage[state.audioConsumers.byId[action.payload].stage],
              (id) => id !== action.payload
            ),
          },
          byProducer: _.omit(
        ...
        videoConsumers: {
          ...
          byStage: {
            ...
            [state.videoConsumers.byId[action.payload].stage]: _.filter(
              state.videoConsumers.byStage[state.videoConsumers.byId[action.payload].stage],
              (id) => id !== action.payload
            ),
          },
          byProducer: _.omit(
