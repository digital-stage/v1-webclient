        ...
        stageMembers: {
          ...
          byStage: {
            ...
            [stageMember.stageId]: upsert<string>(
              state.stageMembers.byStage[stageMember.stageId],
              stageMember._id
            ),
          },
          byGroup: {
            ...
            [stageMember.groupId]: upsert<string>(
              state.stageMembers.byGroup[stageMember.groupId],
              stageMember._id
            ),
          },
      ...
      state = {
        ...
        videoProducers: {
          ...
          byStage: {
            ...
            [videoProducer.stageId]: upsert<string>(
              state.videoProducers.byStage[videoProducer.stageId],
              videoProducer._id
            ),
          },
          byStageMember: {
            ...state.videoProducers.byStageMember,
            [videoProducer.stageMemberId]: upsert<string>(
              state.videoProducers.byStageMember[videoProducer.stageMemberId],
              videoProducer._id
            ),
          },
      ...
      state = {
        ...
        audioProducers: {
          ...
          byStage: {
            ...
            [audioProducer.stageId]: upsert<string>(
              state.audioProducers.byStage[audioProducer.stageId],
              audioProducer._id
            ),
          },
          byStageMember: {
            ...state.audioProducers.byStageMember,
            [audioProducer.stageMemberId]: upsert<string>(
              state.audioProducers.byStageMember[audioProducer.stageMemberId],
              audioProducer._id
            ),
          },
      ...
      state = {
        ...
        ovTracks: {
          ...
          byStageMember: {
            ...
            [ovTrack.stageMemberId]: upsert<string>(
              state.ovTracks.byStageMember[ovTrack.stageMemberId],
              ovTrack._id
            ),
          },
