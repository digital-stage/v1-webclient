...
export const createGainAudioNode = (targetNodes: SingleRootNodes, item: ThreeDimensionAudioProperties, customItem?: ThreeDimensionAudioProperties): GainAudioNode => {
...
export const updateGainAudioNode = (targetNodes: SingleRootNodes, gainAudioNode: GainAudioNode, item: ThreeDimensionAudioProperties, customItem?: ThreeDimensionAudioProperties): GainAudioNode => {
    const audioContext = targetNodes.rootNodes.left.context;
    if (customItem) {
        if (customItem.muted) {
            ...
            gainAudioNode.rootNodes.left.gain.setValueAtTime(
                customItem.volume,
