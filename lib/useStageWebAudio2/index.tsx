...
const StageWebAudioProvider = (props: {
  ...
  const [groupNodes, dispatchGroup] = useReducer<
    Reducer<GainAudioNodeCollection, GroupNodesActions>
  >(groupNodesReducer, {
    byId: {},
  });
  const [stageMemberNodes, dispatchStageMembers] = useReducer<
    Reducer<GainAudioNodeCollection, StageMemberNodesActions>
  >(stageMemberNodesReducer, {
    byId: {},
  });
  const [audioProducerNodes, dispatchAudioProducers] = useReducer<
    Reducer<AudioProducerNodesCollection, AudioProducerNodesActions>
  >(audioProducerNodesReducer, {
    byId: {},
  });
