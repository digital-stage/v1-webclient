...
import {
    useAudioConsumers,
    useAudioProducers,
    useCurrentStageId, useCustomAudioProducers,
    useCustomGroups,
    useCustomStageMembers, useGroups,
    useStageMembersRaw
                                ...
                                if (!prev[item._id]) {
                                    ...
                                    if (customItem) {
                                        ...
                                        const customStageMember = customStageMembers.byStageMember[stageMember._id] ?
                                            customStageMembers.byId[customStageMembers.byStageMember[stageMember._id]] : undefined;
                                        const group = groups.byId[stageMember.groupId];
                                        const customGroup = customGroups.byGroup[stageMember.groupId] ?
                                            customGroups.byId[customGroups.byGroup[stageMember.groupId]] : undefined;
                                        const params = calculate3DAudioParameters(group, customGroup, stageMember, customStageMember, customItem);
                                        ...
                                        const customGroup = customGroups.byGroup[stageMember.groupId] ?
                                            customGroups.byId[customGroups.byGroup[stageMember.groupId]] : undefined;
                                        const params = calculate3DAudioParameters(group, customGroup, stageMember, customStageMember, item);
                                        pannerNode.setPosition(params.x, params.y, params.z);
                                        pannerNode.setOrientation(params.rX, params.rY, params.rZ);
                                    }
                                }
