...
import * as Server from "../../lib/digitalstage/common/model.server";
import {
    CustomGroupVolumeId,
    ...
    StageId,
    StageMemberId
} from "../../lib/digitalstage/common/model.common";
import {useDevices} from "../../lib/digitalstage/useDevices";
import {ClientStageEvents, ServerStageEvents} from "../../lib/digitalstage/common/events";
...
export const StagesContextProvider = (props: {
    ...
    useEffect(() => {
        const stages: ClientModel.Stage[] = stagePrototypes.map(stagePrototype => {
                ...
                groups: groupPrototypes.filter(groupPrototype => groupPrototype.stageId === stagePrototype._id).map(groupPrototype => {
                    ...
                    const group: ClientModel.Group = {
                        ...
                        members: stageMemberPrototypes.filter(groupMemberPrototype => groupMemberPrototype.groupId === groupPrototype._id).map(groupMemberPrototype => {
                            ...
                            const member: ClientModel.GroupMember = {
